<?php
  ...
  * Slug: quantumshop/archive-product
  * Inserter: no
  */
?>
...
<!-- wp:paragraph -->
<p>
     <?php echo esc_html__( 'No products were found matching your selection.', 'quantumshop' ); ?>  </p>
<!-- /wp:paragraph -->
...
<!-- wp:column {"width":"28%"} -->
<div class="wp-block-column" style="flex-basis:28%"><!-- wp:template-part {"slug":"woo-sidebar","theme":"quantumshop","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
