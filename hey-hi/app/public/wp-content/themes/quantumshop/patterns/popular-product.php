 ...
 * Slug: quantumshop/popular-product
 * Categories: quantumshop
 * Keywords: popular-product 
 */
...
$quantumshop_plugin = 'woocommerce/woocommerce.php';
 ...
 if ( $results )  {
?>
<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:0;font-size:38px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Popular Products', 'quantumshop' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--20)"><!-- wp:query {"queryId":34,"query":{"perPage":"8","pages":0,"offset":0,"postType":"product","order":"asc","orderBy":"title","author":"","search":"","exclude":[],"sticky":"","inherit":false,"__woocommerceAttributes":[],"__woocommerceStockStatus":["instock","outofstock","onbackorder"],"taxQuery":null,"parents":[]},"namespace":"woocommerce/product-query"} -->
...
<!-- wp:post-title {"textAlign":"center","level":3,"isLink":true,"style":{"spacing":{"margin":{"bottom":"0.75rem","top":"0"}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"medium","__woocommerceNamespace":"woocommerce/product-query/product-title"} /-->
...
<?php } else{ 
     ...
     <main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"default"}} -->
     ...
     <!-- wp:columns -->
     <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"padding":{"bottom":"0px"}}}} -->
     <div class="wp-block-column is-vertically-aligned-top" style="padding-bottom:0px"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10","padding":{"top":"9px","left":"9px","right":"9px","bottom":"20px"}}},"backgroundColor":"base-2","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
     ...
     <!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"padding":{"bottom":"0px"}}}} -->
     <div class="wp-block-column is-vertically-aligned-top" style="padding-bottom:0px"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10","padding":{"top":"9px","left":"9px","right":"9px","bottom":"20px"}}},"backgroundColor":"base-2","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
     ...
     <!-- wp:paragraph -->
     <p><?php echo esc_html__( '$ 780', 'quantumshop' ); ?></p>
     <!-- /wp:paragraph -->
     ...
     <!-- wp:paragraph -->
     <p><?php echo esc_html__( '$ 102', 'quantumshop' ); ?></p>
     <!-- /wp:paragraph -->
