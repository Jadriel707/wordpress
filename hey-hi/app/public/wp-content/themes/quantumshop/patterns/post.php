...
<h1 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Blogs', 'quantumshop' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
...
<div class="wp-block-group" style="padding-right:15px;padding-bottom:15px;padding-left:15px"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|10"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<p class="has-text-align-center"><?php echo esc_html__( 'No posts found', 'quantumshop' ); ?></p>
<!-- /wp:paragraph -->
